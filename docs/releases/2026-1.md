...
!!! success "CanfarSP 2026.1 - February 26, 2026"
    ...
    - Two new contributed sessions:
        - **WebTerminal** — A simple but effective way to interact with your data in CANFAR, based on `ttyd`
        - **Globus** — A new session to manage CANFAR data transfers. Globus is a service designed specifically for moving very large research datasets. This session makes it easy to transfer large files between CANFAR and your own Globus Connect Personal endpoints or other institutions.
